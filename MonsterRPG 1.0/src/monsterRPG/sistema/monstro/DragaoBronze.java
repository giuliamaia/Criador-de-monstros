...
public class DragaoBronze extends Monstro{
	...
	private void preencherHabilidades() {
		...
		this.getHabilidades().add(new Habilidades("Sopro elemental (de repulsão)", "O dragão exala energia repulsiva em um cone de 30 pés. Cada criatura nessa área precisa passar em um teste de resistência de Força de dificuldade 12, caso contrário a criatura é empurrada 30 pés longe do dragão."));
