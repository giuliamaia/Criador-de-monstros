...
public class DragaoBranco extends Monstro{
	...
	private void preencherHabilidades() {
		this.getHabilidades().add(new Habilidades("Sopro elemental", "O dragão exala uma explosão gelada de granizo em um cone de 15 pés. Cada criatura nessa área precisa fazer um teste de resistência de dificuldade 12, tomando 5d8 de dano gelado numa falha, ou metade do dano num sucesso."));
