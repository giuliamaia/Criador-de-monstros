...
public class Testes {
	public static void main(String[] args) {
		Criatura primeira = new Criatura(10, 10, 5.5, 10, 10, 40, 0, 0, 0, "Tatu",
				"Infelizmente vivemos em uma sociedade em que", Types.BESTA);
		Criatura c1 = new Criatura(10, 10, 5.5, 10, 10, 40, 0, 0, 0, "Noé",
				"Infelizmente vivemos em uma sociedade em que", Types.BESTA);
		...
		Criatura c6 = new Criatura(20, 40, 5.9, 60, 70, 80, 10, 30, 20, "Kaique", "eu vou eu vou pra casa agr eu vou",
				Types.ABERRAÇAO);
		...
		System.out.println("Nomes em ordem alfabetica reverse: "
				+ controlador.ordenarNomesDoRepositorioPorOrdemAlfabeticaReverse());
		...
		System.out.println("Monstros criados entre 15/1/2001 e 3/12/2015: " + controlador
				.filtrarCriaturasCriadasEntreDuasDatas(LocalDate.of(2001, 1, 15), LocalDate.of(2015, 12, 3)));
